...
def calculate_fid_given_paths(paths, img_size=256, batch_size=50):
    ...
    load_fake=get_eval_loader(paths[1],img_size,batch_size,is_count=True,drop_last=True)
    print("1")
...
if __name__ == '__main__':
    ...
    fid_value = calculate_fid_given_paths(['/data/binxin/dataset/afhq/train/dog/','cat2dog-use:official_content_encoder.pt_and_official_cat2dog.pt'], 256, 8)
    print('FID: ', fid_value)
